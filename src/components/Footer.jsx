  ...
  return (
    <footer className="py-12 border-t border-gray-200 dark:border-gray-800 transition-colors duration-300">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col md:flex-row justify-between items-center gap-8">
         ...
         <div className="text-gray-500 dark:text-gray-400 text-sm font-bold uppercase tracking-widest leading-none">
           © {new Date().getFullYear()} Vishal Saxena. All rights reserved.
         </div>
         
         <div className="flex gap-6 text-gray-500 dark:text-gray-400 font-bold text-xs uppercase tracking-widest">
