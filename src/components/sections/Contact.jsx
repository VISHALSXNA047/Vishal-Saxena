...
export default function Contact() {
  ...
  return (
    <section id="contact" className="py-20 relative bg-gray-900 transition-colors duration-300">
      <div className="section-container">
        <div className="flex flex-col items-center mb-16 text-center">
          ...
          <motion.p
            ...
            className="text-gray-300 dark:text-gray-300 max-w-2xl">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
          ...
          <motion.div
            ...
            <div className="bg-gray-900/80 border border-gray-200 dark:border-gray-700 shadow-lg dark:shadow-none p-8 rounded-3xl space-y-8">
               <div className="flex items-start gap-5 group">
                  ...
                  <div>
                     <h4 className="font-bold text-white dark:text-gray-100">Email Me</h4>
                     <p className="text-gray-400 font-medium">vk0902569@gmail.com</p>
                  </div>
               </div>
               ...
               <div className="flex items-start gap-5 group">
                  ...
                  <div>
                     <h4 className="font-bold text-white dark:text-gray-100">Message Me</h4>
                     <p className="text-gray-400 font-medium">itz_vishalsaxena</p>
                  </div>
               </div>
               ...
               <div className="flex items-start gap-5 group">
                  <div className="w-12 h-12 bg-green-500/10 rounded-2xl flex items-center justify-center text-green-500 group-hover:bg-green-500 group-hover:text-white transition-all">
                   ...
                   <div>
                      ...
                      <p className="text-gray-300 font-bold  leading-none mt-1">Shahjahanpur ,Uttar Pradesh, India</p>
                   </div>
               </div>
            </div>

            <div className="bg-gray-950 dark:bg-gray-900 border border-gray-200 dark:border-gray-800 shadow-lg dark:shadow-none p-8 rounded-3xl">
               <h4 className="font-bold text-white mb-6">Social Connect</h4>
            ...
            <div className="bg-grey-800 p-8 rounded-3xl text-white relative overflow-hidden group premium-shadow border border-gray-200 dark:border-gray-800">
               <div className="absolute top-0 right-0 w-32 h-32 bg-gray-950/10 rounded-full translate-x-10 -translate-y-10 group-hover:scale-150 transition-transform duration-700" />
          ...
          <motion.div
            ...
            <div className="bg-gray-950 dark:bg-gray-900 border border-gray-200 dark:border-gray-800 shadow-lg dark:shadow-none p-8 md:p-12 rounded-3xl relative">
  ...
  <p className="text-indigo-400 text-base font-semibold mb-8">
  ...
  {/* Bottom badge */}
  <div className="mt-10 px-5 py-2 rounded-full bg-gray-800/60 border border-gray-700/50 text-gray-400 text-xs tracking-widest uppercase">
