    ...
    <section id="home" className="relative min-h-screen flex items-center pt-20 overflow-hidden">
      ...
      <div className="section-container relative z-10 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
        <motion.div
          ...
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-indigo-500/10 border border-grey-100/10 text-white-600 dark:text-white-400 text-sm font-medium mb-6">
          ...
          <h1 className="text-5xl md:text-7xl font-bold mb-6 leading-tight text-white">
            <span className="text-white">I&apos;m</span> <span className="bg-gradient-to-r from-indigo-500 to-purple-500 bg-clip-text text-transparent">Vishal Saxena</span>
          </h1>

          <div className="text-2xl md:text-3xl font-bold text-gray-800 dark:text-gray-100 mb-8 h-[1.5em] tracking-tight">
          ...
          <div className="flex flex-wrap gap-4 mb-12">
            <Button
              ...
              className="h-14 px-8 text-lg font-semibold bg-indigo-600 text-white hover:bg-indigo-700 dark:bg-indigo-500 dark:hover:bg-indigo-400 transition-all shadow-xl shadow-indigo-500/20 flex items-center gap-2 border-none cursor-pointer hover:scale-105 active:scale-95 duration-200"
              icon={<Send size={20} />}>
      ...
      <Button
        ...
        className="h-14 px-8 text-lg font-semibold border border-gray-200 dark:border-gray-800 transition-all flex items-center gap-2 rounded-xl text-gray-300 bg-gray-950/50 dark:bg-gray-900/50 backdrop-blur-sm hover:border-indigo-500/80 cursor-pointer hover:scale-105 active:scale-95 duration-200"
      ...
      >
        ...
        <motion.div
          ...
          <div className="relative w-full max-w-md mx-auto">
            <div className="relative rounded-3xl overflow-hidden glass-card p-2 group bg-gray-900/80 border border-gray-200 dark:border-gray-700 shadow-xl dark:shadow-none">
              <img
              ...
              <motion.div
                ...
                className="absolute -top-6 -right-6 bg-gray-900/80 border border-gray-200 dark:border-gray-700 shadow-xl p-4 rounded-2xl z-20">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <div className="font-bold text-white text-sm">Designer</div>
                  </div>
                </div>
              </motion.div>
              ...
              <motion.div
                ...
                className="absolute -bottom-6 -left-6 bg-gray-900/80 border border-gray-200 dark:border-gray-700 shadow-xl p-4 rounded-2xl z-20">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <div className="font-bold text-white text-sm">Developer</div>
                  </div>
                </div>
              </motion.div>
            </div>
